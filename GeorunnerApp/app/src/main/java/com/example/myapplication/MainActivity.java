...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_LOGOUT, Menu.NONE, R.string.logout).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
        menu.add(0, MENU_CLEAR, Menu.NONE, R.string.clear).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
        menu.add(0, MENU_CHANGE, Menu.NONE, R.string.changeRoute).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
